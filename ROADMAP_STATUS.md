...
- **operator state:** preparing durable dispatch / resident-worker handoff
- **next action:** verify live `main` and PR #178, then issue or correct the T2 dispatch packet against the exact eligible base
