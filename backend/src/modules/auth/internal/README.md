# `internal/` — private to the /auth module

Files in this directory are implementation details of the **/auth** module.
Other modules MUST NOT import from here. Cross-module imports of
`src/modules/auth/internal/**` are rejected by the static architecture
