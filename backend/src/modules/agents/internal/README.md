# `internal/` — private to the /agents module

Files in this directory are implementation details of the **/agents** module.
Other modules MUST NOT import from here. Cross-module imports of
`src/modules/agents/internal/**` are rejected by the static architecture
