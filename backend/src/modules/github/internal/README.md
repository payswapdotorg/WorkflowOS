# `internal/` — private to the /github module

Files in this directory are implementation details of the **/github** module.
Other modules MUST NOT import from here. Cross-module imports of
`src/modules/github/internal/**` are rejected by the static architecture
