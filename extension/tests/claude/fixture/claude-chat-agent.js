/**
 * WORK-031: Claude chat fixture agent — deterministic stand-in for the real
 ...
 * composer (window.__claudeChatFixture.submits counts REAL submits — the E2E
...
(function () {
  ...
  sendBtn.addEventListener('click', function () {
    ...
    // Conversation creation (observed product behavior: /chat/<uuid>).
